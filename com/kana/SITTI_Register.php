...
class SITTI_Register extends SQLData{
	...
	function notifyUser($key){
		...
		$smtp->host_name="mail.sittibelajar.info";
		//$smtp->host_name="mail.pesansponsor.com";                
		...
		$smtp->localhost="mail.sittibelajar.info";       /* Your computer address */
		...
		$smtp->user="mailbot@sittibelajar.info";                     /* Set to the user name if the server requires authetication */
		//$smtp->user="";
		$smtp->realm="";                    /* Set to the authetication realm, usually the authentication user e-mail domain */
		$smtp->password="Sementara333";                 /* Set to the authetication password */
		//$smtp->password="";
		...
		$headers = 'From: sitti@sittibelajar.com' . "\r\n" .
    'Reply-To: sitti@sittibelajar.com' . "\r\n";
		//print $to;
		
		if($smtp->SendMessage("mailbot@sittibelajar.info",array($to),array(
			"MIME-Version: 1.0",
			"Content-Type: text/html",
			"From: mailbot@sittibelajar.info",
			"To: $to",
			"Subject: $subject",
	...
	function registration_process($name,$email){
		...
		Leave it empty to make the class negotiate if necessary */
			...
			$headers = 'From: mailbot@sittibelajar.info' . "\r\n" .
