...
$LOCALE['LOGIN_SUCCESS_NEXT'] = "Successfully logged in";
...
$LOCALE['LOGIN_NOT_MATCHED'] = "Sorry, your email/password is not matched.";
$LOCALE['LOGIN_REQUIRED_FIELD_NOT_ALL_FILLED'] = "All field are required";
...
$LOCALE['TRANSACTION_EXPIRED'] = "Sorry, your transaction is expired. Please try again.";

$LOCALE['PROFILE_NAME_ALLOWEDCHARS'] = "Only alphabet characters are allowed for Nama.";
$LOCALE['PROFILE_ADDRESS_ALLOWEDCHARS'] = "Only alphanumerics characters are allowed for Alamat.";
$LOCALE['PROFILE_PHONE_ALLOWEDCHARS'] = "Only numerics, strip, and space characters are allowed for Telephone Number.";
$LOCALE['PROFILE_HP_ALLOWEDCHARS'] = "Only numerics, strip, and space characters are allowed for Cell Number.";
$LOCALE['PROFILE_NEWPASSWD_SAVED'] = "Successfully saved New Password";
$LOCALE['PROFILE_NEWPASSWD_FAILED'] = "Sorry, failed to save New Password.";
$LOCALE['PROFILE_PASSWD_NOT_MATCHED'] = "Sorry, the passwords you entered are not matched.";
$LOCALE['PROFILE_OLDPASSWD_NOT_MATCHED'] = "Sorry, your old password is wrong.";
$LOCALE['PROFILE_PASSWD_MIN_CHARS'] = "Sorry, only eight or more characters are allowed for password.";

$LOCALE['REGISTER_REQUIRED_FIELDS'] = "Required Fields (*).";
$LOCALE['REGISTER_PASSWD_FIELDS_LESSTHAN_8CHARS'] = "Minimal 8 characters for password";
$LOCALE['REGISTER_EMAIL_ALREADY_REGISTERED'] = "Sorry, this email is already registered.";
$LOCALE['REGISTER_PASSWD_SHORT'] = 'Password is too short';
$LOCALE['REGISTER_PASSWD_WEAK'] = 'Password is weak';
$LOCALE['REGISTER_PASSWD_STRONG'] = 'Password is strong';
$LOCALE['REGISTER_PASSWD_VERY_STRONG'] = 'Password is very strong';
$LOCALE['REGISTER_PASSWD_SAMEAS_USERNAME'] = 'Password must be differrent than email';
$LOCALE['REGISTER_CONFIRM_SUCCESS'] = "Congratulation, your account is successfully activated. You can log in now.";
$LOCALE['REGISTER_CONFIRM_FAILED'] = "Sorry, could not activate your account.";
$LOCALE['REGISTER_REQUIRED_TERM'] = "You must agree with SITTI term and condition.";

$LOCALE['REFER_SEND_EMAIL_SUCCESS'] = "Email sent successfully!";
$LOCALE['REFER_SEND_EMAIL_FAILED'] = "Failed to send email";
...
$LOCALE['REGISTRATION_SUCCESS'] = "Thank you for registering as an advertiser SITTI.
    ...
    Thank You, <br/>
     SITTI Team
    ";
$LOCALE['EMAIL_CONFIRM_RESEND_SUCCESS'] = "Successfully resend Confirmation Email. Please check your email.";
$LOCALE['EMAIL_CONFIRM_RESEND_FAILED'] = "Sorry, failed to process your request. Please try again.";
$LOCALE['EMAIL_CONFIRM_RESEND_EXPIRED'] = "Sorry, your request is already expired.";
...
$LOCALE['EDIT_CAMPAIGN_DATE_INVALID'] = "Sorry, End Date must be later than the Start Date.";
...
$LOCALE['ADS_SAVE_SUCCESS'] = "Successfully added your ads.";
$LOCALE['ADS_SAVE_FAILED'] = "Failed to save your ads.";
...
$LOCALE['CHART_NO_LATEST_30DAYS_DATA'] = "No latest thirty days data found";
$LOCALE['CHART_NO_CHOSEN_DATES_DATA'] = "No data found for chosen dates";
$LOCALE['CHART_START_DATE_BIGGERTHAN_END_DATE'] = "End Date must be later than Start Date";
?>