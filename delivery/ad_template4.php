...
<div style="width: 620px; height: 50px; overflow: hidden; padding: 2px; display: table; border: 1px solid rgb(204, 204, 204); background-color: rgb(255, 255, 255); font-family: Arial,Helvetica,sans-serif;">
<?php for($i=0;$i<sizeof($list);$i++):?> 
    <div style="padding: 0 5px 0 0; display: table; width: 190px; float: left;">
    <h1 style="color: #FF6600; font-size: 11px; margin: 0pt; font-weight:bold;"><?=stripslashes($list[$i]['judul'])?></h1>
