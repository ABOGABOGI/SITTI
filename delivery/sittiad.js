...
var myurl = 'http://www.sittibelajar.com/beta/delivery/showads.php';

var mtrack_sapiers_rand = parseInt(Math.random()*999999999999999);
var mtrack_sapiers_modurl = myurl+"?rand="+mtrack_sapiers_rand+'&sitti_pub_id='+sitti_pub_id+'&type='+sitti_ad_type;
