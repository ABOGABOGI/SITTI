...
<div style="width: 280px; height: 230px; overflow: hidden; padding: 5px; display: table; border: 1px solid rgb(204, 204, 204); background-color: rgb(255, 255, 255); font-family: Arial,Helvetica,sans-serif;">
<?php for($i=0;$i<sizeof($list);$i++):?> 
    <div style="padding:0 0 10px 0; display:block; width:280px;height:70px; clear:both;">
    <h1 style="color: #FF6600; font-size: 12px; margin: 0pt; font-weight:bold;"><?=stripslashes($list[$i]['judul'])?></h1>
