...
$(document).ready(function(){
	...
	$("#160x600").click(function(){
		//centering with css
		centerPopup();
		//load popup
		loadPopup160x600();
	});
	$("#250x250").click(function(){
		//centering with css
		centerPopup();
		//load popup
		loadPopup250x250();
	});
	$("#300x160").click(function(){
		//centering with css
		centerPopup();
		//load popup
		loadPopup300x160();
	});
	$("#300x250").click(function(){
		//centering with css
		centerPopup();
		//load popup
		loadPopup300x250();
	});
	$("#336x280").click(function(){
		//centering with css
		centerPopup();
		//load popup
		loadPopup336x280();
	});
	$("#468x60").click(function(){
		//centering with css
		centerPopup();
		//load popup
		loadPopup468x60();
	});
	$("#520x70").click(function(){
		//centering with css
		centerPopup();
		//load popup
		loadPopup520x70();
	});
	$("#610x60").click(function(){
		//centering with css
		centerPopup();
		//load popup
		loadPopup610x60();
	});
	$("#728x90").click(function(){
		//centering with css
		centerPopup();
		//load popup
		loadPopup728x90();
	});
	$("#940x70").click(function(){
		//centering with css
		centerPopup();
		//load popup
		loadPopup940x70();
